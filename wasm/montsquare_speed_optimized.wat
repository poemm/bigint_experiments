(module
  ...
  (func $less_than_or_equal768_64bitlimbs (type 4) (param i32 i32) (result i64)
    ...
    local.get 4)
  (func $square768_64bitlimbs (type 0) (param i32 i32)
    ...
    i32.add
    global.set 0)
  (func $montreduce768_64bitlimbs (type 1) (param i32 i32 i32 i32)
  ...
  (func $montsquare768_64bitlimbs (type 1) (param i32 i32 i32 i32)
    (local i32)
    global.get 0
    i32.const 192
    i32.sub
    ...
    i32.add
    global.set 0)
  (func $__multi3 (type 7) (param i32 i64 i64 i64)
    (local i64 i64)
    local.get 0
    local.get 2
    local.get 3
