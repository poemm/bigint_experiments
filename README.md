```
This is a header-only library for the following bigint arithmetic:
...
// How to compile:
g++ myprogram.cpp -o myprogram -w -I/path/to/this/file's/directory
./myprogram

Use notes:
 - The limb types and numbers of limbs must be known at compile-time for C++ templates.
 - computation is little-endian wrt limbs i.e. least-significant limb first. It is possible to change indices to be big-endian.
```
