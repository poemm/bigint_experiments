...
mul256x256_512:	# computes mul256x256_512, where pointers: out in a0, a in a1, b in a2
	...
	# write result for this limb, prepare for next limb
	sw	t1, 32(t0)	# write result for this 32-bit limb
	srli	t1, t1, 32	# the upper 32-bits is carry
	slli	t2, t2, 32	# overflow is in upper 32-bits
	add	t1, t1, t2	# add overflow of carry
	mv	t2, zero	# re-init overflow to zero
	...
	# write result for this limb, prepare for next limb
	sw	t1, 36(t0)	# write result for this 32-bit limb
	srli	t1, t1, 32	# the upper 32-bits is carry
	slli	t2, t2, 32	# overflow is in upper 32-bits
	add	t1, t1, t2	# add overflow of carry
	mv	t2, zero	# re-init overflow to zero
	...
	# write result for this limb, prepare for next limb
	sw	t1, 40(t0)	# write result for this 32-bit limb
	srli	t1, t1, 32	# the upper 32-bits is carry
	slli	t2, t2, 32	# overflow is in upper 32-bits
	add	t1, t1, t2	# add overflow of carry
	mv	t2, zero	# re-init overflow to zero
	...
	# write result for this limb, prepare for next limb
	sw	t1, 44(t0)	# write result for this 32-bit limb
	srli	t1, t1, 32	# the upper 32-bits is carry
	slli	t2, t2, 32	# overflow is in upper 32-bits
	add	t1, t1, t2	# add overflow of carry
	mv	t2, zero	# re-init overflow to zero
	...
	# write result for this limb, prepare for next limb
	sw	t1, 48(t0)	# write result for this 32-bit limb
	srli	t1, t1, 32	# the upper 32-bits is carry
	slli	t2, t2, 32	# overflow is in upper 32-bits
	add	t1, t1, t2	# add overflow of carry
	mv	t2, zero	# re-init overflow to zero
	...
	# write result for this limb, prepare for next limb
	sw	t1, 52(t0)	# write result for this 32-bit limb
	srli	t1, t1, 32	# the upper 32-bits is carry
	slli	t2, t2, 32	# overflow is in upper 32-bits
	add	t1, t1, t2	# add overflow of carry
	mv	t2, zero	# re-init overflow to zero
	...
	# write result for this limb, prepare for next limb
	sw	t1, 56(t0)	# write result for this 32-bit limb
	srli	t1, t1, 32	# the upper 32-bits is carry
	slli	t2, t2, 32	# overflow is in upper 32-bits
	add	t1, t1, t2	# add overflow of carry
	mv	t2, zero	# re-init overflow to zero
	...
	sw	t1, 60(t0)	# write result for this 32-bit limb
