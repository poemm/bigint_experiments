	...
	.text
mul256x256_512:	// computes mul256x256_512, where pointers: out in x0, a in x1, b in x2
...
# first bring in x1 and x2 to registers x6-x12, this frees x1 and x2
	...
	// write result for this limb, prepare for next limb
	str	w1, [x0,32]	// write result for this 32-bit limb
	lsr	x1, x1, 32	// the upper 32-bits is carry
	lsl	x2, x2, 32	// overflow is in upper 32-bits
	add	x1, x1, x2	// add overflow of carry
	mov	x2, 0		// re-init overflow to zero
	...
	// write result for this limb, prepare for next limb
	str	w1, [x0,36]	// write result for this 32-bit limb
	lsr	x1, x1, 32	// the upper 32-bits is carry
	lsl	x2, x2, 32	// overflow is in upper 32-bits
	add	x1, x1, x2	// add overflow of carry
	mov	x2, 0		// re-init overflow to zero
	...
	// write result for this limb, prepare for next limb
	str	w1, [x0,40]	// write result for this 32-bit limb
	lsr	x1, x1, 32	// the upper 32-bits is carry
	lsl	x2, x2, 32	// overflow is in upper 32-bits
	add	x1, x1, x2	// add overflow of carry
	mov	x2, 0		// re-init overflow to zero
	...
	// write result for this limb, prepare for next limb
	str	w1, [x0,44]	// write result for this 32-bit limb
	lsr	x1, x1, 32	// the upper 32-bits is carry
	lsl	x2, x2, 32	// overflow is in upper 32-bits
	add	x1, x1, x2	// add overflow of carry
	mov	x2, 0		// re-init overflow to zero
	...
	// write result for this limb, prepare for next limb
	str	w1, [x0,48]	// write result for this 32-bit limb
	lsr	x1, x1, 32	// the upper 32-bits is carry
	lsl	x2, x2, 32	// overflow is in upper 32-bits
	add	x1, x1, x2	// add overflow of carry
	mov	x2, 0		// re-init overflow to zero
	...
	// write result for this limb, prepare for next limb
	str	w1, [x0,52]	// write result for this 32-bit limb
	lsr	x1, x1, 32	// the upper 32-bits is carry
	lsl	x2, x2, 32	// overflow is in upper 32-bits
	add	x1, x1, x2	// add overflow of carry
	mov	x2, 0		// re-init overflow to zero
	...
	// write result for this limb, prepare for next limb
	str	w1, [x0,56]	// write result for this 32-bit limb
	lsr	x1, x1, 32	// the upper 32-bits is carry
	lsl	x2, x2, 32	// overflow is in upper 32-bits
	add	x1, x1, x2	// add overflow of carry
	mov	x2, 0		// re-init overflow to zero
	...
	str	w1, [x0,60]	// write result for this 32-bit limb
